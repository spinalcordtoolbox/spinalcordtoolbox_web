...
<link type="text/css" href="${request.static_url('spinaltoolbox:static/css/volume-viewer-demo.css')}" rel="Stylesheet" />
<link type="text/css" href="${request.static_url('spinaltoolbox:static/css/common.css')}" rel="Stylesheet" />
<link type="text/css" href="${request.static_url('spinaltoolbox:static/css/ui-darkness/jquery-ui-1.8.10.custom.css')}" rel="Stylesheet" />
...
<script src="${request.static_url('spinaltoolbox:static/js/viewer/ui.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/brainbrowser.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/core/tree-store.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/lib/config.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/lib/utils.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/lib/events.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/lib/loader.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/lib/color-map.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/lib/display.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/lib/panel.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/lib/utils.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/modules/loading.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/modules/rendering.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/overlay.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/minc.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/nifti1.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/viewer/gunzip.min.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/volume-viewer.config.js')}"></script>
<script src="${request.static_url('spinaltoolbox:static/js/volume-viewer.js')}"></script>
<script>

            ...
            <div class="row">
                <div class="col-md-3 widget">
                    ...
                    <div class="widget-body">
                        ...
                        <a href="mailto:#">wpinaud@polymtl.ca</a><br>
                        <br>
                        2900 Boulevard Edouard-Montpetit<br>
                        Montréal, QC H3T 1J4
                    </p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 widget">
                    <div class="widget-body">
                        ...
                        <b><a href="${request.route_url('signin')}">Sign up</a></b>
                    </p>
                    </div>
                </div>
                <div class="col-md-6 widget">
                    <div class="widget-body">
                        <p class="text-right">
                        Copyright © 2015, Spinal Cord Toolbox Web.</p>
                    </div>
                </div>
            </div>
            <!-- /row of widgets -->

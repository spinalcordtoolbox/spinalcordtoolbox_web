...
<link type="text/css" href="${request.static_url('server:static/css/ui-darkness/jquery-ui-1.8.10.custom.css')}" rel="Stylesheet" />
...
<script src="${request.static_url('server:static/js/volume-viewer.js')}"></script>
<script>

...
<link type="text/css" href="${request.static_url('spinaltoobox:static/css/volume-viewer-demo.css')}" rel="Stylesheet" />
<link type="text/css" href="${request.static_url('spinaltoobox:static/css/common.css')}" rel="Stylesheet" />
<link type="text/css" href="${request.static_url('spinaltoobox:static/css/ui-darkness/jquery-ui-1.8.10.custom.css')}" rel="Stylesheet" />
...
<div class="container">
    ...
    <div class="row">
        ...
        <article class="col-md-8 maincontent">
            ...
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/lib/config.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/lib/utils.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/lib/events.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/lib/loader.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/lib/color-map.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/lib/display.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/lib/panel.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/lib/utils.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/modules/loading.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/modules/rendering.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/overlay.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/minc.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/brainbrowser/volume-viewer/volume-loaders/nifti1.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/viewer/gunzip.min.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/volume-viewer.config.js')}"></script>
            <script src="${request.static_url('spinaltoobox:static/js/volume-viewer.js')}"></script>

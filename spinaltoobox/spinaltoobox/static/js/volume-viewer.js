...
$(function() {
  ...
  window.viewer = BrainBrowser.VolumeViewer.start("brainbrowser", function(viewer) {
    ...
    $("#volume-file-submit-nifti").click(function() {
      viewer.loadVolumes({
          volumes: [
            {
              type: "nifti1",
              nii_url: document.getElementById("nii-file"),
              template: {
                element_id: "volume-ui-template",
                viewer_insert_class: "volume-viewer-display"
              }
    ...
    ////////////////////////////////////////
    viewer.setDefaultPanelSize(233, 233);
    ...
    viewer.loadVolumes({
      ...
      complete: function() {
        ...
        viewer.setPanelSize(233, 233, { scale_image: true });
      }
    });
  });
});
